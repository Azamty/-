...
type Job = {
  ...
  v2?: {
    ...
    separation?: { artifact_id?: string; duration_sec?: number; warnings?: readonly string[] } | null;
...
function App() {
  ...
  const submit = async () => {
    ...
    setAnalysisSuggestion(null); setBpm("120"); setKey("C"); setMeter("4/4"); setRollVisible(true); setMergeMainMelody(false);
    try {
