...
import { canPersistSelection, parseSelectionDraft, resolveInitialJobId, resolveSelectionValues, SELECTION_DRAFT_SCHEMA, SELECTION_DRAFT_VERSION, selectionStorageKey, type ManualSelectionFields } from "./selectionState";
