...
在仓库根目录双击 `scripts/start_server.cmd`，服务监听 `http://127.0.0.1:8000`。网页支持 `?job=<UUID>` 直达已有 V2 任务，URL 中的任务优先于本机上次保存的任务；无效 UUID 不会加载旧任务。当前验收任务：

- Seaside Steps：`http://127.0.0.1:8000/?job=a7428e72-c181-48cd-9953-f19247955d8e`
- Luv Letter：`http://127.0.0.1:8000/?job=7acc1e55-86ea-445a-bb8f-59f4478a0b2a`
